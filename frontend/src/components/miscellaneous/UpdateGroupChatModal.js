...
const UpdateGroupChatModal = ({ fetchMessages, fetchAgain, setFetchAgain }) => {
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://mernchatapp-gpg8.onrender.com/api/chat/rename`,
        {
  ...
  const handleAddUser = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://mernchatapp-gpg8.onrender.com/api/chat/groupadd`,
        {
          chatId: selectedChat._id,
          userId: user1._id,
        },
  ...
  const handleRemove = async (user1) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `https://mernchatapp-gpg8.onrender.com/api/chat/groupremove`,
        {
          chatId: selectedChat._id,
          userId: user1._id,
        },
  ...
  const handleDeleteGroup = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `https://mernchatapp-gpg8.onrender.com/api/chat/delete`,
        {
